...
public class BuildingSearchBuilderConverter {
    public BuildingSearchBuilder toBuildingSearchBuilder(BuildingSearchRequest buildingSearchRequest,
        ...
        BuildingSearchBuilder buildingSearchBuilder = new BuildingSearchBuilder.Builder()
                ...
                .setDistrictid(BuildingSearchRequestUtil.getObject(buildingSearchRequest.getDistrict(), String.class))
                .setNumberOfBasement(
                        BuildingSearchRequestUtil.getObject(buildingSearchRequest.getNumberOfBasement(), Long.class))
                .setTypeCode(typeCode)
                .setManagerName(
                        BuildingSearchRequestUtil.getObject(buildingSearchRequest.getManagerName(), String.class))
                .setManagerPhone(
                        BuildingSearchRequestUtil.getObject(buildingSearchRequest.getManagerPhone(), String.class))
                .setRentPriceTo(BuildingSearchRequestUtil.getObject(buildingSearchRequest.getRentPriceTo(), Long.class))
                .setRentPriceFrom(
                        BuildingSearchRequestUtil.getObject(buildingSearchRequest.getRentPriceFrom(), Long.class))
